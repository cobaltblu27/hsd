...
HD_PWD='/csehome/cobaltblu27/HSD/project/verilog_project/verilog_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pe_con.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pe_con.tcl
