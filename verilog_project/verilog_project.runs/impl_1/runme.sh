...
HD_PWD='/csehome/cobaltblu27/HSD/project/verilog_project/verilog_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pe_con.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pe_con.tcl -notrace
